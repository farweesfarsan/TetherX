...
//       try {
//         const walletId = userData.sellerWalletId;
//         console.log("wallet id is",walletId);
//         const response = await axios.get(`http://localhost:3001/wallet/${walletId}`);
//         setBalanceUSD(response.data.balanceUSD);
//         setBalanceLKR(response.data.balanceLKR);
//       } catch (error) {
...
//            My Wallet
//        </div>
//        <div className="flex items-center mr-[120px] "> {/* Added margin-left */}
...
//                </div>
//            </div>
//            <div className="flex items-center ml-[20px]"> {/* Adjusted margin-left */}
...
//                <div className='bg-gray-700 px-3 py-1 rounded-md  hover:text-[#458ab3]'>Overview</div>
//                <div className='bg-gray-700 px-3 py-1 rounded-md hover:text-[#458ab3]'>Transfer</div>
//                <div className='bg-gray-700 px-3 py-1 rounded-md hover:text-[#458ab3]'>Deposit</div>
//                <div className='bg-gray-700 px-3 py-1 rounded-md hover:text-[#458ab3]'>Withdraw</div>
//            </div> 
...
//              <div className='font-medium text-[40px] ml-[-30px]'>0.0000</div>
//              <div className='mt-[25px] ml-[20px] font-medium'>USDT</div>
//              </div>
//              <div className=' absolute ml-[-30px] mt-[10px] text-gray-300'>0 LKR</div>
      ...
      {userData ? (
        <>
          ...
          {activeSection === 'Transfer' && (
            <div className='px-12 py-12 ml-[250px] mt-[30px] w-[1000px]'>
              <p className='text-white'>Transfer Section</p>
            </div>
          )}
